...
export const HomePage: React.FC = () => {
  ...
  return (
    <main className="bg-oyishi-bg text-oyishi-text">
      ...
      <Suspense fallback={
        <div className="py-24 text-center text-oyishi-gold font-mono text-xs tracking-widest uppercase animate-pulse">
      ...
      {/* Map Section (VERIFIED FUENLABRADA EMBED - Compacted Vertical Height 260-280px) */}
      <section className="h-[260px] md:h-[280px] w-full bg-oyishi-bg relative">
        <iframe 
          ...
          className="w-full h-full contrast-[1.05] brightness-[0.9]"
        ></iframe>
      </section>
    </main>
  );
