        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              variants={fadeInUp}
              className="bg-oyishi-card border border-oyishi-border rounded-2xl p-8 shadow-xl hover:border-oyishi-gold/50 transition-all duration-300 flex flex-col justify-between"
            >
              <div>
                ...
                <p className="text-oyishi-textSec text-xs font-mono uppercase tracking-wider mb-4">Líneas Directas</p>
              ...
              <div className="pt-6 border-t border-oyishi-border/40 mt-6">
                <a 
                  ...
                  className="btn-shimmer focus-ring w-full py-2.5 bg-oyishi-gold text-[#120E0C] font-mono text-xs uppercase tracking-wider rounded font-bold flex items-center justify-center gap-2"
                >
                  <Phone size={14} />
            ...
            >
              <div>
                ...
                <p className="text-oyishi-textSec text-xs font-mono uppercase tracking-wider mb-4">Correo Electrónico</p>
              ...
              <div className="pt-6 border-t border-oyishi-border/40 mt-6">
                <a 
                  ...
                  className="btn-shimmer focus-ring w-full py-2.5 border border-oyishi-gold/50 text-oyishi-gold font-mono text-xs uppercase tracking-wider rounded font-semibold flex items-center justify-center gap-2 hover:bg-oyishi-gold hover:text-[#120E0C] transition-all"
                >
                  <Send size={14} />
            ...
            >
              <div>
                ...
                <p className="text-oyishi-textSec text-xs font-mono uppercase tracking-wider mb-4">Fuenlabrada</p>
              ...
              <div className="pt-6 border-t border-oyishi-border/40 mt-6">
                <a 
                  ...
                  className="btn-shimmer focus-ring w-full py-2.5 border border-oyishi-border text-oyishi-text font-mono text-xs uppercase tracking-wider rounded flex items-center justify-center gap-2 hover:border-oyishi-gold hover:text-oyishi-gold transition-all"
                >
                  <MapPin size={14} />
                  <span>VER MAPA</span>
                </a>
          ...
          {/* MAPA EMBED */}
          <div className="bg-[#1A1513] border border-oyishi-border/80 rounded-2xl overflow-hidden shadow-2xl p-4">
            <div className="flex items-center gap-3 p-4 border-b border-oyishi-border/40 font-mono text-xs text-oyishi-gold">
              <Clock size={16} />
